 ...
 function createEpochNft(name,params,approvalProgram,clearProgram,price,from){
    ...
    let appArgs =[new Uint8Array(Buffer.from(`${parseInt(price)}`)),new Uint8Array(Buffer.from(`${parseInt(5)}`)),new Uint8Array(Buffer.from("YGCKHAG4H3WDUQSAY5J4MK5ZIWLGIF7W6ZYO5EZY3OGZJB5FWGDNBX7BUA")),new Uint8Array(Buffer.from("IKEPBSW7RSPN4TXYC3AV6FOOGZ6PJLTJKEB2PVCTPSRFNB3CANZ5JJRZPY")), new Uint8Array(Buffer.from("2FSBHE3XAXJHBFFUABPPBBU3ZL4PQAHI6BB3KTHJKL5IZCC7BG4LR6GRT4")), new Uint8Array(Buffer.from("UONII5HLZPHGDCBCETVTFGX42I5MJWEYKM5NUIFQW3A47CSDIHZN74AYUA")), new Uint8Array(Buffer.from("EMMEIOWLZPMUCXSLGB5QOR33HCQZAQT6KSRGCXHBO54W7LNLQCJXSGJ4IQ")), new Uint8Array(Buffer.from("UNH443RNFL4NWFCP5AI3N34C6IK6SWDEPZRLFKXGWYTXBZ5BTLJJLGWLRQ")), new Uint8Array(Buffer.from("QPNWTRS3FLRUICYYLVPQV7QZIJPBNM2EV6S5BF6JOFQL7DGCLU5HKQSUK4"))];
    console.log(appArgs);
    let globalBytes =10;
    let globalInts = 3;
    let localBytes =1;
